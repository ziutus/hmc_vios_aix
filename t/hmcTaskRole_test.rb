...
class MyHmcTaskRoles < Test::Unit::TestCase
  ...
  # Fake test
  def test_TaskRolehmcservicerep
    ...
    taskRole = TaskRole.new(string)

    assert_equal('Predefined',     taskRole.parent,   'taskrole - parent')
    assert_equal('hmcservicerep',  taskRole.name,     'taskrole - name')

#    assert_equal(1,  taskRole.can("frame:DeactivateFrameIO"),     "taskrole - have resource frame:DeactivateFrameIO")
