...
o- / ......................................................................................................................... [...]
  o- backstores .............................................................................................................. [...]
  | o- block .................................................................................................. [Storage Objects: 5]
  | | o- linux1_1_lv ........................................................ [/dev/iscsi_vg/linux1_1_lv (10.0GiB) write-thru activated]
  | | o- linux1_2_lv ........................................................ [/dev/iscsi_vg/linux1_2_lv (10.0GiB) write-thru activated]
  | | o- linux3_lv .......................................................... [/dev/iscsi_vg/linux3_lv (10.0GiB) write-thru activated]
  | | o- linux2_lv .......................................................... [/dev/iscsi_vg/linux2_lv (36.0MiB) write-thru activated]
  | | o- linux4_1_lv ........................................................ [/dev/iscsi_vg/linux4_1_lv (20.0GiB) write-thru activated]
  | o- fileio ................................................................................................. [Storage Objects: 0]
  | o- pscsi .................................................................................................. [Storage Objects: 0]
  | o- ramdisk ................................................................................................ [Storage Objects: 0]
  o- iscsi ............................................................................................................ [Targets: 1]
  ...
  |   o- tpg1 ..................................................................................... [gen-acls, tpg-auth, 1-way auth]
  |     o- acls .......................................................................................................... [ACLs: 4]
  |     | o- iqn.2016-11.linux1.localnet .............................................................. [auth via tpg, Mapped LUNs: 1]
  |     | | o- mapped_lun0 .............................................................................. [lun4 block/linux3_lv (rw)]
  |     | o- iqn.2016-11.linux2.localnet .............................................................. [auth via tpg, Mapped LUNs: 1]
  |     | | o- mapped_lun0 .............................................................................. [lun4 block/linux1_lv (rw)]
  |     | o- iqn.2016-11.linux3.localnet ............................................................. [auth via tpg, Mapped LUNs: 3]
  |     | | o- mapped_lun0 .............................................................................. [lun0 block/linux1_lv (rw)]
  |     | | o- mapped_lun1 ............................................................................. [lun1 block/linux2_1_lv (rw)]
  |     | | o- mapped_lun2 ............................................................................. [lun2 block/linux2_2_lv (rw)]
  |     | o- iqn.2016-11.vios2.localnet ............................................................. [auth via tpg, Mapped LUNs: 3]
  |     |   o- mapped_lun0 .............................................................................. [lun0 block/linux3_lv (rw)]
  |     |   o- mapped_lun1 ............................................................................. [lun1 block/linux2_1_lv (rw)]
  |     |   o- mapped_lun2 ............................................................................. [lun2 block/linux2_2_lv (rw)]
  |     o- luns .......................................................................................................... [LUNs: 5]
  |     | o- lun0 ........................................................................ [block/disk1_lv (/dev/iscsi_vg/disk1_lv)]
  |     | o- lun1 ...................................................................... [block/aix1_1_lv (/dev/iscsi_vg/linux1_1_lv)]
  |     | o- lun2 ...................................................................... [block/aix1_2_lv (/dev/iscsi_vg/linux1_2_lv)]
  |     | o- lun3 ...................................................................... [block/nim1_1_lv (/dev/iscsi_vg/linux2_1_lv)]
  |     | o- lun4 ........................................................................ [block/lpar2_lv (/dev/iscsi_vg/linux3_lv)]
  |     o- portals .................................................................................................... [Portals: 1]
  |       o- 192.168.200.20:3260 .............................................................................................. [OK]
  o- loopback ......................................................................................................... [Targets: 0]
  o- vhost ............................................................................................................ [Targets: 0]
